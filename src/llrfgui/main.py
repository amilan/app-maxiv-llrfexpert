...
def create_panels(splashscreen, gui, section, loops_device, diags_device,
                  is_expert, llrf_device=None, llrfdiags_device=None):
...
def run(period=PERIOD):
    ...
    if options.expert:
        ...
        section, loops, diags, llrf, llrfdiags = get_model(options.expert,
                                                           options.rf_room)
    ...
    create_panels(splashscreen, gui, section, loops, diags,
                  options.expert, llrf, llrfdiags)
