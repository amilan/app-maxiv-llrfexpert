...
from llrfGUI.oldVersion.ui_llrf import Ui_LLRF
from tih import *
...
class llrfGUI(QtGui.QMainWindow):
    ...
    @alert_problems
    def openVCXO(self):
        from llrfGUI.oldVersion import VCXODialog
    ...
    def openOVRLoops(self):
        from llrfGUI.oldVersion import OVRLoops
    ...
    def openOVRDiag(self):
        from llrfGUI.oldVersion import OVRDiag
