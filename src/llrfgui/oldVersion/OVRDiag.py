...
from llrfGUI.oldVersion.ui_OVRDiag import Ui_Form
...
class OVRDiag(QtGui.QDialog):
    ...
    def setModel(self,device):
        ...
        self.widgetList = [self.ui.taurusBoolLed,
                           ...
                           self.ui.taurusBoolLed_9,
                           self.ui.taurusBoolLed_10,
                           self.ui.taurusBoolLed_11,
                           self.ui.taurusBoolLed_12, 
                           self.ui.taurusBoolLed_13,
                           self.ui.taurusBoolLed_14,
                           self.ui.taurusBoolLed_15,
                           self.ui.taurusBoolLed_16
                          ]
...
def main():
    ...
    widget = OVRDiag('WS/RF/Lyrtech-02')
    widget.show()
    sys.exit(app.exec_())
