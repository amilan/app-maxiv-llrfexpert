...
###############################################################################
##     Fpga Version is a widget used for the LLRF Expert GUI.
##
...
class FpgaVersion(BaseLLRFWidget):
   ...
   #         self.connect_combobox(combobox[0], combobox[1])
    ...
    def _create_attributes_lists(self):
        ...
        self._attributes_readback = [
            (self.ui.tauValueLabel_loopVersion, self._device_name + "/VersionDate"),
            (self.ui.tauValueLabel_diagVersion, self._device_diag_name + "/VersionDate"),
        ]
