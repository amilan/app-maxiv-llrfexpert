...
class ItckOutDiag(Qt.QWidget):
    ...
    def _create_attributes_lists(self):
        ...
        self._attributes_readback = [
            (self.ui.taurusBoolLed_21, "/DACsOffDiagA"),
            (self.ui.taurusBoolLed_22, "/PinSwitchDiagA"),
            (self.ui.taurusBoolLed_45, "/TriggerFDLDiagA"),
            (self.ui.taurusBoolLed_46, "/TriggerDiagFDLDiagA"),
            (self.ui.taurusBoolLed_47, "/OutputPLCDiagA"),
            (self.ui.taurusBoolLed_48, "/OutputUpperLevelDiagA"),
        ]
