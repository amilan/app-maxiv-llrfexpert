...
#                 (self.ui.lineEdit_cavVolt_3, self._device_name + "/CavityVoltA"),
        ...
        self._attributes_readback = [
            ...
            (self.ui.tauValueLabel_cavVolt_4, "CavityVoltA"),
            (self.ui.tauValueLabel_voltInc_2, "VoltageRateIncreaseB"),
            (self.ui.taurusBoolLed_23, "Vacuum1A"),
            (self.ui.taurusBoolLed_24, "Vacuum2A"),
            ]
...
#           (self.ui.comboBox_pulseMode, self._device_name + "/PulseModeEnableA"),
            (self.ui.comboBox_voltInc_2, "VoltageRateIncrease"),
        ]
